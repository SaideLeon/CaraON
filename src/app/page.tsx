...
export default function EnhancedLandingPage() {
  return (
    <div>
      ...
      <section className="relative overflow-hidden pt-20 pb-16 md:pt-28 md:pb-24">
        ...
        <div className="container relative z-10 mx-auto flex max-w-5xl flex-col items-center gap-6 px-4 text-center md:gap-8">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight tracking-tighter font-headline">
            <span className="block mb-1 md:mb-2 animate-fade-in">Automatize seu Atendimento</span>
            <span className="block mb-1 md:mb-2 animate-fade-in [animation-delay:500ms]">no WhatsApp com</span>
          ...
          <p className="max-w-3xl text-base md:text-lg lg:text-xl text-slate-600 dark:text-slate-300 leading-relaxed animate-fade-in [animation-delay:1500ms]">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md mt-6 animate-fade-in [animation-delay:2000ms]">
            <Button asChild className="flex-1 group relative overflow-hidden rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-3 sm:px-8 sm:py-4 text-white font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 h-auto text-base">
              <Link href="/register">
            ...
            <Button asChild variant="outline" className="flex-1 rounded-lg border-2 border-slate-300 bg-white/80 backdrop-blur-sm px-6 py-3 sm:px-8 sm:py-4 text-slate-700 font-semibold hover:bg-white hover:shadow-lg hover:scale-105 transition-all duration-300 h-auto text-base">
      ...
      {/* Features Section */}
      <section className="relative py-16 md:py-24 bg-white/50 dark:bg-slate-800/20 backdrop-blur-sm">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl text-center mb-12 md:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 md:mb-6 animate-fade-in font-headline">
            ...
            <p className="text-base md:text-lg text-slate-600 dark:text-slate-400 leading-relaxed animate-fade-in [animation-delay:500ms]">
              Tudo que você precisa para criar uma experiência de atendimento excepcional.
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-white to-slate-100 dark:from-slate-800 dark:to-slate-900/50 p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-2 animate-fade-in [animation-delay:1000ms]">
              ...
              <div className="relative z-10">
                <div className="mb-6 flex h-14 w-14 md:h-16 md:w-16 items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-white to-slate-100 dark:from-slate-800 dark:to-slate-900/50 p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-2 animate-fade-in [animation-delay:1500ms]">
              ...
              <div className="relative z-10">
                <div className="mb-6 flex h-14 w-14 md:h-16 md:w-16 items-center justify-center rounded-full bg-gradient-to-r from-purple-500 to-pink-600 text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-white to-slate-100 dark:from-slate-800 dark:to-slate-900/50 p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-2 animate-fade-in [animation-delay:2000ms] md:col-span-2 lg:col-span-1">
              ...
              <div className="relative z-10">
                <div className="mb-6 flex h-14 w-14 md:h-16 md:w-16 items-center justify-center rounded-full bg-gradient-to-r from-green-500 to-teal-600 text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-5xl">
            <div className="relative group animate-fade-in [animation-delay:1000ms]">
              ...
              <div className="relative bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-2xl p-1 md:p-2 shadow-2xl hover:shadow-3xl transition-shadow duration-500">
      ...
      <section className="py-16 md:py-24 bg-slate-800 relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 text-center text-white">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 animate-fade-in font-headline">
            Pronto para transformar seu atendimento?
          </h2>
          <p className="text-lg md:text-xl mb-8 opacity-90 max-w-2xl mx-auto animate-fade-in [animation-delay:500ms]">
